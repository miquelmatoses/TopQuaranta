# Generated by Django 5.2 on 2026-04-10 06:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('territori', models.CharField(choices=[('CAT', 'Catalunya'), ('VAL', 'País Valencià'), ('BAL', 'Illes Balears'), ('ALL', 'Tots els territoris')], default='CAT', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artista', models.ForeignKey(help_text='Denormalized from album for query performance.', on_delete=django.db.models.deletion.CASCADE, related_name='cancons', to='music.artista')),
            ],
            options={
                'verbose_name': 'Cançó',
